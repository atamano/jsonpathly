...
export default class JSONPathListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by JSONPathParser#identifier.
	enterIdentifier(ctx) {
	}

	// Exit a parse tree produced by JSONPathParser#identifier.
	exitIdentifier(ctx) {
	}
